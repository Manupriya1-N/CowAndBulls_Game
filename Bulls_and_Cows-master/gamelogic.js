...
function proverka(input) {
	input.value = input.value.replace(/[^0-9\.]+/g, ''); //  /[^0-9\.]+/g, ''
	
	if(input.value === ""){
	input.style.border="1px solid red";
	document.getElementById('checkednumber1').disabled=true;
	document.getElementById('checkednumber2').disabled=true;
	document.getElementById('checkednumber3').disabled=true;
	document.getElementById('checkednumber4').disabled=true;
	document.getElementById('checkednumber5').disabled=true;
	document.getElementById('checkednumber6').disabled=true;
	document.getElementById('checkednumber7').disabled=true;
	}else{
		input.style.border="";		
	document.getElementById('checkednumber1').disabled=false;
	document.getElementById('checkednumber2').disabled=false;
	document.getElementById('checkednumber3').disabled=false;
	document.getElementById('checkednumber4').disabled=false;
	document.getElementById('checkednumber5').disabled=false;
	document.getElementById('checkednumber6').disabled=false;
	document.getElementById('checkednumber7').disabled=false;
	}
};
